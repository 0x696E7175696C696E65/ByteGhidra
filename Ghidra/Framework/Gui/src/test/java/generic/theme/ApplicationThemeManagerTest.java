...
public class ApplicationThemeManagerTest {
	...
	@Test
	public void testDefaultThemeIsFlatDark() {
		GTheme defaultTheme = ThemeManager.getDefaultTheme();

		assertTrue(defaultTheme instanceof FlatDarkTheme);
		assertEquals(LafType.FLAT_DARK, defaultTheme.getLookAndFeelType());
	}
