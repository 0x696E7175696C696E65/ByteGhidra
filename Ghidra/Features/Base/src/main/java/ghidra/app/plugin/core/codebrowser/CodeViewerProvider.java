...
public class CodeViewerProvider extends NavigatableComponentProviderAdapter
	...
	private void createActions() {
		...
		new ActionBuilder("Find Crackme Auth Checks", plugin.getName())
		...
		new ActionBuilder("Find Game Logic/Data Structures", plugin.getName())
	...
	private void showCrackmeAuthChecks() {
		...
		TableComponentProvider<CrackmeAuthCheckCandidate> tableProvider =
			tableService.showTableWithMarkers(title, "Crackme Auth Checks", model,
				SearchConstants.SEARCH_HIGHLIGHT_COLOR, markerIcon, title, this);
	...
	private void showGameAnalysisResults() {
		...
		if (!GameAnalysisOptions.confirmOfflineUse(tool, getComponent())) {
		...
		TableComponentProvider<GameAnalysisCandidate> tableProvider =
			tableService.showTableWithMarkers(title, "Game Analysis", model,
				SearchConstants.SEARCH_HIGHLIGHT_COLOR, markerIcon, "Game Analysis", this);
		tableProvider.installRemoveItemsAction();
	}
