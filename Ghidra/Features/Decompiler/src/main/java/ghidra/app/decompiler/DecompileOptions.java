...
public class DecompileOptions {
	...
	public final static String PSEUDOCODE_QUALITY_OPTIONSTRING =
		"Analysis.Enhanced pseudocode quality";
	private final static String PSEUDOCODE_QUALITY_OPTIONDESCRIPTION =
		"If set, enables Byte Ghidra's extra native pseudocode structuring passes. " +
			"Disable only for troubleshooting; other readability defaults remain configurable separately.";
	private final static boolean PSEUDOCODE_QUALITY_OPTIONDEFAULT = true;	// Must match Architecture::resetDefaultsInternal
	private boolean pseudocodeQuality;
	...
	private final static boolean NULLTOKEN_OPTIONDEFAULT = true;		// Must match PrintC::resetDefaultsPrintC
	...
	private final static boolean INPLACEOP_OPTIONDEFAULT = true;	// Must match PrintC::resetDefaultsPrintC
	...
	private final static AliasBlockEnum ALIASBLOCK_OPTIONDEFAULT = AliasBlockEnum.All;	// Must match Architecture::resetDefaultsInternal
	...
	private final static int MAXWIDTH_OPTIONDEFAULT = 120;	// Must match EmitPrettyPrint::resetDefaultsPrettyPrint
	...
	private final static String COMMENTEOL_OPTIONDESCRIPTION =
		"If set, disassembly end-of-line (EOL) comments are displayed " +
			"in the decompiler C output";
	private final static boolean COMMENTEOL_OPTIONDEFAULT = true;	// Must match PrintLanguage::resetDefaultsInternal
	...
	public DecompileOptions() {
		...
		pseudocodeQuality = PSEUDOCODE_QUALITY_OPTIONDEFAULT;
	...
	public void grabFromToolAndProgram(ToolOptions fieldOptions, ToolOptions opt, Program program) {
		...
		pseudocodeQuality =
			opt.getBoolean(PSEUDOCODE_QUALITY_OPTIONSTRING, PSEUDOCODE_QUALITY_OPTIONDEFAULT);
		splitStructures =
	...
	public void registerOptions(ToolOptions fieldOptions, ToolOptions opt, Program program) {
		...
		opt.registerOption(PSEUDOCODE_QUALITY_OPTIONSTRING, PSEUDOCODE_QUALITY_OPTIONDEFAULT,
			new HelpLocation(HelpTopics.DECOMPILER, "AnalysisPseudocodeQuality"),
			PSEUDOCODE_QUALITY_OPTIONDESCRIPTION);
	...
	public void encode(Encoder encoder, DecompInterface iface) throws IOException {
		...
		appendOption(encoder, ELEM_PSEUDOCODEQUALITY, pseudocodeQuality ? "on" : "off", "", "");
	...
	/**
	 * {@return true if the enhanced pseudocode quality passes are enabled.}
	 * @see #PSEUDOCODE_QUALITY_OPTIONDESCRIPTION
	 */
	public boolean isPseudocodeQualityEnabled() {
		return pseudocodeQuality;
	}

	/**
	 * Set whether enriched pseudocode cleanup and recovery passes should run.
	 * @param enabled true to enable enhanced pseudocode quality
	 * @see #PSEUDOCODE_QUALITY_OPTIONDESCRIPTION
	 */
	public void setPseudocodeQualityEnabled(boolean enabled) {
		this.pseudocodeQuality = enabled;
	}
