...
//==================================================================================================
	...
	private void createActions(boolean isConnected) {
		...
		EnhancedPseudocodeQualityAction enhancedPseudocodeQualityAction =
			new EnhancedPseudocodeQualityAction(plugin);
		...
		addLocalAction(enhancedPseudocodeQualityAction);
