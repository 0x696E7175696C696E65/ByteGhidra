...
extern ElementId ELEM_PSEUDOCODEQUALITY;	///< Marshaling element \<pseudocodequality>
...
class OptionPseudocodeQuality : public ArchOption {
public:
  OptionPseudocodeQuality(void) { name = "pseudocodequality"; }	///< Constructor
  virtual string apply(Architecture *glb,const string &p1,const string &p2,const string &p3) const;
};
